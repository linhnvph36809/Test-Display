      ...
      <div className="create-shipments">
        ...
        <div className="create-shipments__main">
          <div className="create-shipments__top">
            <div className="flex justify-between items-center create-shipments__heading">
              <Title level={4} className="create-shipments__heading--base">
                <FormattedMessage id="createShipments.selectInventoryToShip" />
              </Title>
              <p className="color-primary text-sm">
                <FormattedTranslations
                  id={"createShipments.clickHereDetails"}
                />
              </p>
            </div>
          </div>
              ...
              <div className="create-shipments__shiping">
                <div className="create-shipments__item">
                  <div className="create-shipments__content">
                    <h5 className="create-shipments__title">
                      <FormattedTranslations
                        id={"createShipments.shippingSource"}
                      />
                    </h5>
                    <p className="create-shipments__text">
                      Interline Corporation C/O Ryota, Mari, Manee, 2203 E.
                      Carson St., Unit A-3、 Carson. CA. 90810, US
                    </p>
                    <p
                    ...
                    >
                      <FormattedTranslations
                        id={"createShipments.shipsFromAnotherAddress"}
                      />
                    </p>
                  </div>
                  <div>
