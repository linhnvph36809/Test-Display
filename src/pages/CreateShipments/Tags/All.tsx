...
import { allRows, allColumns } from "../datas";
    ...
    <>
      ...
      <div className="create-shipments__end flex justify-between p-y-4">
        ...
        <div className="p-x-4">
          ...
          <button className="create-shipments__btn create-shipments__btn--disabled">
            確定して続ける
          </button>
        </div>
      </div>
      <ModalComponent
        ...
        footer={[
          ...
          <Button key="link" type="primary" className="modal__btn--submit">
            保存
          </Button>,
        ]}
      >
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="color-primary text-base font-normal">
                  ...
                  Protein 14.5g Zinc Royal Jelly Power | Supports Healthy Hair
                  Skin Nail Immune System - Set of 10 Bottles
                </p>
