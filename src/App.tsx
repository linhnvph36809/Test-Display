      ...
      <Layout>
        ...
        <Layout className="content">
          ...
          <Flex gap={"8px"} align="center" className="content__infor">
            <Paragraph className="content__label">氏名</Paragraph>
            <Paragraph className="content__description">
              : アラキジュンペイ
            </Paragraph>
          </Flex>
          <Flex gap={"8px"} align="center" className="content__infor">
            <Paragraph className="content__label">メールアドレス</Paragraph>
            <Paragraph className="content__description">
          ...
          <Form className="content__form">
            <Flex gap={"16px"}>
              <Input
                ...
                placeholder="トラッキング一覧"
              />
              <Button className="content__btn">送信</Button>
            </Flex>
          </Form>
